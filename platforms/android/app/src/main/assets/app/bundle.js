...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("../node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("../node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _posting_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./app/posting.service.ts");
/* harmony import */ var _user_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./app/user.service.ts");
/* harmony import */ var _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("../node_modules/@auth0/angular-jwt/index.js");
/* harmony import */ var _datatransfer_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./app/datatransfer.service.ts");
/* harmony import */ var _dynamic_add_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("./app/dynamic-add.service.ts");
/* harmony import */ var _logincheck_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("./app/logincheck.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(logincheckService, transferService, router, postingService, userService, addService) {
        this.logincheckService = logincheckService;
        this.transferService = transferService;
        this.router = router;
        this.postingService = postingService;
    ...
    HomeComponent.prototype.loadViews = function () {
        document.getElementById('num_rides_given').innerHTML = this.user.rides_given;
        document.getElementById('num_rides_received').innerHTML = this.user.rides_received;
    ...
    HomeComponent.prototype.cleanFeed = function () {
        var myNode = document.getElementById("bigfeed");
        while (myNode.firstChild) {
            myNode.removeChild(myNode.firstChild);
        }
    ...
    HomeComponent.prototype.decodeToken = function (idToken) {
    ...
    HomeComponent.prototype.getParameterByName = function (name) {
    ...
    HomeComponent.prototype.changeTab = function (evt, tab) {
    ...
    HomeComponent.prototype.changeModalTab = function (evt, tab) {
        // Declare all variables
        var i, tabcontent, tablinks;
        // Get all elements with class="tabcontent" and hide them
    ...
    HomeComponent.prototype.submit = function (type) {
        this.span.click();
        if (type == 'offer') {
    ...
    HomeComponent.prototype.filter = function (newsType) {
        var requestContent = document.getElementsByClassName("request");
        var offerContent = document.getElementsByClassName("offer");
        if (newsType == "offer") {
    ...
    HomeComponent.prototype.addPost = function (date, pickup, destination, comments, price, capacity) {
        var _this = this;
        if (price === void 0) { price = ""; }
        if (capacity === void 0) { capacity = "-1"; }
        this.postingService.addPosting(this.user.username, pickup, destination, date, price, capacity, comments).subscribe(function () {
            _this.loadPostings();
        });
    };
    HomeComponent.prototype.toHistory = function () {
        this.transferService.setData(this.user);
        this.router.navigateByUrl('/history');
    };
    HomeComponent.prototype.toSettings = function () {
        this.transferService.setData(this.user);
    ...
    HomeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_logincheck_service__WEBPACK_IMPORTED_MODULE_7__["LogincheckService"], _datatransfer_service__WEBPACK_IMPORTED_MODULE_5__["TransferService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"],
            _posting_service__WEBPACK_IMPORTED_MODULE_2__["PostingService"], _user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"], _dynamic_add_service__WEBPACK_IMPORTED_MODULE_6__["DynamicAddService"]])
    ], HomeComponent);
